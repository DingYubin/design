...
import guava.wrapper.forward.ForwardingCollection;
...
public final class ObjectSizeUtil {
    private static final ForwardingCollection<Object> CHECKED_OBJECTS = new ForwardingCollection<Object>() {
        @Override
        protected Collection<Object> delegate() {
            return null;
        }
    };
    private static ObjectSizeUtil instrument;
